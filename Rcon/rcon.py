...
class RconConnection(object):
    ...
    def __init__(
        self, server, port=27015, password="", single_packet_mode=False
    ):
        ...
        Parameters:
            ...
            single_packet_mode (bool) set to True for servers which do not hand 0-length SERVERDATA_RESPONSE_VALUE # noqa: E501
    ...
    def _authenticate(self, password):
        ...
        # The server should respond with a SERVERDATA_RESPONSE_VALUE followed by SERVERDATA_AUTH_RESPONSE. # noqa: E501
    ...
    def exec_command(self, command):
        ...
        """
        cmd_pkt = RconPacket(
            next(self.pkt_id), SERVERDATA_EXECCOMMAND, command
        )
    ...
    def read_response(self, request=None, multi=False):
        ...
        Parameters:
            request (RconPacket) if request is provided, read_response() will check that the response ID matches the # noqa: E501
                specified request ID
            multi (bool) set to True if read_response() should check for a multi packet response. If the current # noqa: E501
                RconConnection has single_packet_mode enabled, this parameter is ignored. # noqa: E501
        ...
        if not self.single_packet_mode and multi:
            if not request:
                raise ValueError(
                    "Must specify a request packet in order to"
    ...
    def _read_multi_response(self, req_pkt):
        ...
        for part in body_parts:
            body_parts_strings.append(part.decode())
        return RconPacket(
            req_pkt.pkt_id,
            SERVERDATA_RESPONSE_VALUE,
